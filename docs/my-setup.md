...
| `showpatch` (own script, `bin` package) | show a proposed patch file before applying it, same red and green; apply with `git apply FILE.patch` | `showpatch fix.patch` | core |
